...
const CategoryIcon: React.FC<CategoryIconProps> = ({ categoryName, className = 'w-6 h-6' }) => {
  const renderIcon = () => {
    switch (categoryName.toLowerCase()) {
      ...
      case 'braiding services':
        return (
          <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
             <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3.75H19.5M8.25 6.75H19.5M8.25 9.75H19.5M8.25 12.75H19.5m-11.25-.75a3 3 0 01-3-3V8.25a3 3 0 013-3h3.75a3 3 0 013 3v3.75a3 3 0 01-3 3H8.25zm-1.125 9.75h5.25m-5.25 0a3 3 0 01-3-3V16.5a3 3 0 013-3h5.25a3 3 0 013 3v3.75a3 3 0 01-3 3m-5.25 0h5.25" />
          </svg>
        );
      case 'nail services':
        return (
          <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a7.464 7.464 0 01-1.15 3.993m1.989 3.559A11.209 11.209 0 008.25 10.5a3.75 3.75 0 117.5 0c0 .527-.021 1.049-.064 1.565M12 10.5a14.94 14.94 0 01-3.698 9.75H15.75A14.94 14.94 0 0112 10.5z" />
          </svg>
        );
